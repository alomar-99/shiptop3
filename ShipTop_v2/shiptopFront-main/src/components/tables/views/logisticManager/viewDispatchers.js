...
import AddDispatcher from "./addDI";
function createData(
  reference_number,
  service_type,
  destinationPhone,
...
export default function EnhancedTable({ Display, setDispatcher }) {
  ...
  const fetchData = async (searchQ, filterV) => {
    ...
    axios
      .get(
        `${config.API_ROOT}/api/logisticManager/viewDispatchers${
  ...
  return (
    <div className={classes.root}>
      ...
      **/}
      ...
      <AddDispatcher open={isOpen} onClose={() => setIsOpen(false)}></AddDispatcher>
                      ...
                      {Display === "View" ? (
                        ...
                        <TableCell align="center" key="action">
                          <Button
                            ...
                            color="secondary"
                            className={classes.spacing}
                            onClick={() => {setDispatcher(row.employeeID)}}
                          >
                            Assign
                          </Button>
                        </TableCell>
