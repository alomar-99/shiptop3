...
//test this
let myWorker = new worker.Worker(73246,"khalid","qasim","k8474@gmail.com",'966548546325','hud72947',78948)
let myShelf = new shelf.Shelf(12,8,3,9,"second",false, 65468,3548);
let myShipment = new shipments.Shipment(92371,35529,35.3,'led light',30.0,12.0,10.4,1,'arrived','996553322100','Dhahran','testAddress4','ahmed','Jeddah','Mekkah','2022-5-28','2022-2-10')
...
// myWManager.addWorker(myWorker,7);
// myWManager.addConsignor(myConsignor,49);
